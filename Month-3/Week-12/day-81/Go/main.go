...
func googleLogo(w http.ResponseWriter, req *http.Request) {
	...
	s.Path("M272.1 107.7c38.8-.6 76.3 14 104.4 40.8l77.7-77.7C405 24.6 339.7-.8 272.1 0 169.2 0 75.1 58 28.9 150l90.4 70.1c21.5-64.5 81.8-112.4 152.8-112.", "fill=\"#ea4335\"")
	s.End()
}
